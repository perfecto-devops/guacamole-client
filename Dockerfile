...
RUN mkdir /compile && cd /compile && git clone https://github.com/apache/incubator-guacamole-client.git && cd /compile/incubator-guacamole-client && git checkout 8564f05eadc89aa91bf4c36a446de54140c79ed3 && mvn install
